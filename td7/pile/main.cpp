...
// Pile<int> *pi = new PileChainnee<int>(10);
Pile<PileTableau<int>> *ppti = new PileChainnee<PileTableau<int>>(1);
PileTableau<int> pti(1, 10);
ppti->empiler(pti);
// std::cout << *pi << std::endl;
std::cout << *ppti << std::endl;
